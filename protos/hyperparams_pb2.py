...
_HYPERPARAMS_ACTIVATION = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(         #added of the ELU
      name='ELU', index=3, number=3,
      options=None,
      type=None),

    _descriptor.EnumValueDescriptor(         #added of the PRELU
      name='PRELU', index=4, number=4,
      options=None,
      type=None),
  ],
  containing_type=None,
