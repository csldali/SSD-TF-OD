...
def create_ssd_anchors(num_layers=6,          #genere anchors for the ssd model 
                       min_scale=0.2,
                       max_scale=0.95,
  ...
  Args:
    ...
    min_scale: scale of anchors corresponding to finest resolution (float)  #this is corresponding to Sk in the paper which will decide the scale of the each anchor or default boxes 
...
#Min - Max scale  -  lowest layer has a scale of 0.2 and the highest layer has a scale of 0.9


  if base_anchor_size is None:
    base_anchor_size = [1.0, 1.0]     #these are hard coded and very much fixed 
