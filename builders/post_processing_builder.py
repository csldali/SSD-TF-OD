...
def build(post_processing_config):
  ...
  non_max_suppressor_fn = _build_non_max_suppressor(            #we take some parameters 
      post_processing_config.batch_non_max_suppression)
  score_converter_fn = _build_score_converter(          #this is for the score converter function 
...
def _build_non_max_suppressor(nms_config):
  ...
  if nms_config.max_detections_per_class > nms_config.max_total_detections:  #total detection is hundred 
