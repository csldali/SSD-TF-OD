...
def build(optimizer_config, global_summaries):
  ...
  """
  optimizer_type = optimizer_config.WhichOneof('optimizer')   #get the optimizer params from the config file 
  optimizer = None

  if optimizer_type == 'rms_prop_optimizer':
    config = optimizer_config.rms_prop_optimizer
    optimizer = tf.train.RMSPropOptimizer(              #object for train
